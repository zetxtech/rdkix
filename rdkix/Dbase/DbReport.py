...
try:
  ...
  try:
    from pyRDkix.utils import chemdraw
  except ImportError:
    hasCDX = 0
  else:
    hasCDX = 1
  ...
  from rdkix.Chem.Draw import DrawUtils
  ...
  from rdkix.Reports.PDFReport import PDFReport, ReportUtils
  from rdkix.sping.ReportLab.pidReportLab import RLCanvas as Canvas
  from rdkix.utils import cactvs
