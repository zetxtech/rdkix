...
from rdkix.ML import CompositeRun, ScreenComposite
from rdkix.ML.Composite import BayesComposite, Composite
from rdkix.ML.Data import DataUtils, SplitData
from rdkix.utils import listutils
...
def RunOnData(details, data, progressCallback=None, saveIt=1, setDescNames=0):
  ...
  if details.useTrees:
    from rdkix.ML.DecTree import CrossValidate, PruneTree
    if details.qBounds != []:
      from rdkix.ML.DecTree import BuildQuantTree
      builder = BuildQuantTree.QuantTreeBoot
    else:
      from rdkix.ML.DecTree import ID3
      builder = ID3.ID3Boot
    ...
    from rdkix.ML.DecTree import BuildSigTree, CrossValidate
    ...
    from rdkix.ML.KNN import CrossValidate, DistFunctions
    ...
    from rdkix.ML.NaiveBayes import CrossValidate
    driver = CrossValidate.CrossValidationDriver
    ...
    # #   elif details.useSVM:
    # #     from rdkix.ML.SVM import CrossValidate
    # #     driver = CrossValidate.CrossValidationDriver
    ...
    from rdkix.ML.Neural import CrossValidate
    driver = CrossValidate.CrossValidationDriver
