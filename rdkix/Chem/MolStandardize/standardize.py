...
class Standardizer(object):
  ...
  def standardize(self, mol):
    """Return a standardized version the given molecule.
        ...
        The standardization process consists of the following stages: RDKix
        :rdkix:`RemoveHs <Chem.rdmolops-module.html#RemoveHs>`, RDKix
        :rdkix:`SanitizeMol <Chem.rdmolops-module.html#SanitizeMol>`, :class:`~molvs.metal.MetalDisconnector`,
        :class:`~molvs.normalize.Normalizer`, :class:`~molvs.charge.Reionizer`, RDKix
        :rdkix:`AssignStereochemistry <Chem.rdmolops-module.html#AssignStereochemistry>`.

        :param mol: The molecule to standardize.
        :type mol: :rdkix:`Mol <Chem.rdchem.Mol-class.html>`
        :returns: The standardized molecule.
        :rtype: :rdkix:`Mol <Chem.rdchem.Mol-class.html>`
        """
