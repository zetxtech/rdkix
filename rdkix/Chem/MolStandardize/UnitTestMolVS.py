...
class TestCase(unittest.TestCase):
  dataPCS_standardize_smiles100k = os.path.join(RDConfig.RDBaseDir, 'rdkix', 'Chem',
                                                'MolStandardize', 'test_data',
                                                '100kPCS_standardize_sm.csv.gz')
  dataPCS_standardize_smiles1k = os.path.join(RDConfig.RDBaseDir, 'rdkix', 'Chem', 'MolStandardize',
                                              'test_data', '1kPCS_standardize_sm.csv.gz')
  dataPCS_nomralized1k = os.path.join(RDConfig.RDBaseDir, 'rdkix', 'Chem', 'MolStandardize',
                                      'test_data', '1kPCS_normalized.csv.gz')
  dataPCS_nomralized100k = os.path.join(RDConfig.RDBaseDir, 'rdkix', 'Chem', 'MolStandardize',
                                        'test_data', '100kPCS_normalized.csv.gz')
  dataPCS_metal100k = os.path.join(RDConfig.RDBaseDir, 'rdkix', 'Chem', 'MolStandardize',
                                   'test_data', '100kPCS_metals.csv.gz')
  dataPCS_metal1k = os.path.join(RDConfig.RDBaseDir, 'rdkix', 'Chem', 'MolStandardize', 'test_data',
                                 '1kPCS_metals.csv.gz')
  dataPCS_reionize100k = os.path.join(RDConfig.RDBaseDir, 'rdkix', 'Chem', 'MolStandardize',
                                      'test_data', '100kPCS_reionize.csv.gz')
  dataPCS_reionize1k = os.path.join(RDConfig.RDBaseDir, 'rdkix', 'Chem', 'MolStandardize',
                                    'test_data', '1kPCS_reionize.csv.gz')
  dataPCS_fragment100k = os.path.join(RDConfig.RDBaseDir, 'rdkix', 'Chem', 'MolStandardize',
                                      'test_data', '100kPCS_fragment.csv.gz')
  dataPCS_fragmnet1k = os.path.join(RDConfig.RDBaseDir, 'rdkix', 'Chem', 'MolStandardize',
                                    'test_data', '1kPCS_fragment.csv.gz')
  dataPCS_tautomer100k = os.path.join(RDConfig.RDBaseDir, 'rdkix', 'Chem', 'MolStandardize',
                                      'test_data', '100kPCS_tautomer.csv.gz')
  dataPCS_tautomer1k = os.path.join(RDConfig.RDBaseDir, 'rdkix', 'Chem', 'MolStandardize',
                                    'test_data', '1kPCS_tautomer.csv.gz')
  dataPCS_validate100k = os.path.join(RDConfig.RDBaseDir, 'rdkix', 'Chem', 'MolStandardize',
                                      'test_data', '100kPCS_validate.csv.gz')
  dataPCS_validate1k = os.path.join(RDConfig.RDBaseDir, 'rdkix', 'Chem', 'MolStandardize',
                                    'test_data', '1kPCS_validate.csv.gz')
    ...
    for data in self.readPCSdata(self.dataPCS_standardize_smiles100k):
      try:
        ...
        raise AssertionError(
          f'Line {data.lineNo}: MolVS standardization failed for SMILES {data.smiles}')
      self.assertEqual(ss, data.expected)
