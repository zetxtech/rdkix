...
class TestCase(unittest.TestCase):
  ...
  def testStereoParsingIsConsistent(self):
    smiles_that_are_the_same = [
      ...
      ),  # RDKix used to parse these as different isomers, and ChemAxon removes this stereochemistry entirely

      # example from Dalke report here: https://www.mail-archive.com/rdkix-discuss@lists.sourceforge.net/msg05296.html
      ...
      # ring cases, RDKix parsed these as different isomers before https://github.com/rdkit/rdkit/issues/1652 was fixed
      ...
      # bridge-head ring case, RDKix already agreed with all the other toolkits on this case
      ...
      ('Cl[C@@H]1[C@@H](Cl)C(Cl)CCN1',
       '[C@H](Cl)1[C@@H](Cl)C(Cl)CCN1'),  # RDKix thinks these are different
