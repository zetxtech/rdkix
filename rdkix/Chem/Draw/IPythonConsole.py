...
_DrawRDKixBitSaved = None


def DrawRDKixBit(mol, bitId, bitInfo, drawOptions=drawOptions, **kwargs):
  global _DrawRDKixBitSaved
  if _DrawRDKixBitSaved is not None:
    fn = _DrawRDKixBitSaved
  else:
    fn = Draw.DrawRDKixBit
  return _DrawBit(fn, mol, bitId, bitInfo, drawOptions=drawOptions, **kwargs)


DrawRDKixBit.__doc__ = Draw.DrawRDKixBit.__doc__

_DrawRDKixBitsSaved = None


def DrawRDKixBits(*args, drawOptions=drawOptions, **kwargs):
  global _DrawRDKixBitsSaved
  if _DrawRDKixBitsSaved is not None:
    fn = _DrawRDKixBitsSaved
  else:
    fn = Draw.DrawRDKixBits
  return _DrawBit(fn, *args, drawOptions=drawOptions, **kwargs)


DrawRDKixBits.__doc__ = Draw.DrawRDKixBits.__doc__
...
def InstallIPythonRenderer():
  global _MolsToGridImageSaved, _DrawRDKixBitSaved, _DrawRDKixBitsSaved, _DrawMorganBitSaved, _DrawMorganBitsSaved
  ...
  _DrawRDKixBitSaved = Draw.DrawRDKixBit
  Draw.DrawRDKixBit = DrawRDKixBit
  _DrawRDKixBitsSaved = Draw.DrawRDKixBits
...
def UninstallIPythonRenderer():
  global _MolsToGridImageSaved, _DrawRDKixBitSaved, _DrawMorganBitSaved, _DrawMorganBitsSaved
  ...
  if _DrawRDKixBitSaved is not None:
    Draw.DrawRDKixBit = _DrawRDKixBitSaved
  if _DrawRDKixBitsSaved is not None:
    Draw.DrawRDKixBits = _DrawRDKixBitsSaved
  if _DrawMorganBitSaved is not None:
