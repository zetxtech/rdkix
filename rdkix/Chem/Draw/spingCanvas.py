...
class Canvas(CanvasBase):
  ...
  def __init__(self, size, name, imageType='png'):
    if imageType == "pdf":
      from rdkix.sping.PDF.pidPDF import PDFCanvas as _Canvas
    elif imageType == "ps":
      from rdkix.sping.PS.pidPS import PSCanvas as _Canvas
    elif imageType == "svg":
      from rdkix.sping.SVG.pidSVG import SVGCanvas as _Canvas
    elif imageType == "png":
      from rdkix.sping.PIL.pidPIL import PILCanvas as _Canvas
    else:
