...
patch_rdkix_docstrings = importlib.import_module("patch_rdkix_docstrings")
CppFile = patch_rdkix_docstrings.CppFile
ClangWorkerData = patch_rdkix_docstrings.ClangWorkerData
