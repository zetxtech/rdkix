...
if __name__ == "__main__":
    ...
    gen_rdkix_stubs = importlib.import_module("gen_rdkix_stubs")
    ...
    if hasattr(ExtractSignaturesFromPybind11Docstrings, "parse_function_docstring"):
        ...
        def parse_function_docstring_patched(self, func_name, doc_lines, **kwargs):
            doc_lines = gen_rdkix_stubs.ProcessDocLines.process(args.module_name, doc_lines, keep_incorrect_staticmethods)
    ...
    gen_rdkix_stubs.copy_stubs(os.path.join(args.tempdir, *args.module_name.split(".")), args.outer_dirs)
