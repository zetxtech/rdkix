/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM IRDKix.idl
 */

#ifndef __gen_IRDKix_h__
#define __gen_IRDKix_h__
...
/* starting interface:    IRDKix */
#define IRDKIX_IID_STR "bfb9acf3-9349-47ec-8984-f6f8e2f02f65"
...
class NS_NO_VTABLE IRDKix : public nsISupports {
 public:
  NS_DEFINE_STATIC_IID_ACCESSOR(IRDKIX_IID)
...
/* Use this macro to declare functions that forward the behavior of this
 * interface to another object in a safe way. */
#define NS_FORWARD_SAFE_IRDKIX(_to)                                            \
  NS_IMETHOD Strlen(const char *arg, PRUint32 *_retval) {                      \
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(_MYCLASS_, IRDKix)
