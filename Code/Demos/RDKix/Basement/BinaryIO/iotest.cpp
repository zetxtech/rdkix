...
//       All Rights Reserved
//
// The tests in this file demonstrate the use of RDKix with
...
void test1() {
  ...
  std::string fname2 =
      rdbase + "/Code/Demos/RDKix/BinaryIO/test_data/triazine.mol.gz";
  RWMol *m;
...
void test3() {
  ...
  BOOST_LOG(rdInfoLog)
      ...
      << std::endl;
  std::string rdbase = getenv("RDBASE");
  std::string fname2 = rdbase + "/Code/Demos/RDKix/BinaryIO/test_data/mols.rdb";
...
void test4() {
  ...
  BOOST_LOG(rdInfoLog) << "testing writing pickles to a single compressed file "
                       ...
                       << std::endl;
  std::string rdbase = getenv("RDBASE");
  std::string fname2 = rdbase + "/Code/Demos/RDKix/BinaryIO/test_data/mols.rdz";
...
void test5() {
  ...
  BOOST_LOG(rdInfoLog) << "testing writing compressed pickles to a single file "
                       ...
                       << std::endl;
  std::string rdbase = getenv("RDBASE");
  std::string fname2 = rdbase + "/Code/Demos/RDKix/BinaryIO/test_data/tmp.rdz";
