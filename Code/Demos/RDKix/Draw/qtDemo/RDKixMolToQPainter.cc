...
//
// Draw an RDKix Drawing into a QPainter object.
// Hacked together by analogy with the SVG drawer in
// $RDBASE/Code/Demos/RDKix/Draw/demo.cpp
//
