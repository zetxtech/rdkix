...
void test1() {
  ...
  TEST_ASSERT(RDKix::feq(f1.getPos().x, 1.0));
  TEST_ASSERT(RDKix::feq(f1.getPos().y, 1.0));
  TEST_ASSERT(RDKix::feq(f1.getPos().z, 1.0));
  ...
  TEST_ASSERT(RDKix::feq(f2.getPos().x, 1.0));
  TEST_ASSERT(RDKix::feq(f2.getPos().y, 1.0));
  TEST_ASSERT(RDKix::feq(f2.getPos().z, 1.0));
  ...
  TEST_ASSERT(RDKix::feq(f3.getPos().x, 1.0));
  TEST_ASSERT(RDKix::feq(f3.getPos().y, 1.0));
  TEST_ASSERT(RDKix::feq(f3.getPos().z, 1.0));

  FreeChemicalFeature f4(f2);
  TEST_ASSERT(f4.getId() == 123);
  TEST_ASSERT(f4.getFamily() == "foo");
  TEST_ASSERT(f4.getType() == "bar");
  TEST_ASSERT(RDKix::feq(f4.getPos().x, 1.0));
  TEST_ASSERT(RDKix::feq(f4.getPos().y, 1.0));
  TEST_ASSERT(RDKix::feq(f4.getPos().z, 1.0));
