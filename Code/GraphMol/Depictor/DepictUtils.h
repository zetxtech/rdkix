 ...
 */
RDKIX_DEPICTOR_EXPORT RDGeom::INT_POINT2D_MAP embedRing(const RDKix::INT_VECT &ring);
...
RDKIX_DEPICTOR_EXPORT bool hasTerminalRGroupOrQueryHydrogen(const RDKix::ROMol &query);
