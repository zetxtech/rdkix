...
RDKIX_GRAPHMOL_EXPORT void removeBadStereo(ROMol &mol);
...
RDKIX_GRAPHMOL_EXPORT int pickBondToWedge(const Atom *atom, const ROMol &mol,
                                          ...
                                          int noNbrs);
RDKIX_GRAPHMOL_EXPORT void setStereoanyFromSquiggleBond(ROMol &mol, Bond *bond,
...
RDKIX_GRAPHMOL_EXPORT bool canBeStereoBond(const Bond *bond);
