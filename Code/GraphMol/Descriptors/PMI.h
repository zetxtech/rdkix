...
RDKIX_DESCRIPTORS_EXPORT double NPR1(const ROMol&, int confId = -1,
...
//!  from Sauer and Schwarz JCIM 43:987-1003 (2003)
//!  https://doi.org/10.1021/ci025599w
RDKIX_DESCRIPTORS_EXPORT double NPR2(const ROMol&, int confId = -1,
                                     bool useAtomicMasses = true,
                                     bool force = false);
const std::string NPR2Version = "1.0.0";

//! First (smallest) principal moment of inertia
RDKIX_DESCRIPTORS_EXPORT double PMI1(const ROMol&, int confId = -1,
                                     bool useAtomicMasses = true,
                                     bool force = false);
const std::string PMI1Version = "1.0.0";
//! second principal moment of inertia
RDKIX_DESCRIPTORS_EXPORT RDKIX_DESCRIPTORS_EXPORT double PMI2(
...
RDKIX_DESCRIPTORS_EXPORT double PMI3(const ROMol&, int confId = -1,
                                     bool useAtomicMasses = true,
                                     bool force = false);
...
*/
RDKIX_DESCRIPTORS_EXPORT double radiusOfGyration(const ROMol&, int confId = -1,
                                                 bool useAtomicMasses = true,
                                                 bool force = false);
...
/*!
 ...
 Definition:
   pm2 / (pm1*pm3)
*/
RDKIX_DESCRIPTORS_EXPORT double inertialShapeFactor(const ROMol&,
                                                    int confId = -1,
                                                    bool useAtomicMasses = true,
                                                    bool force = false);
...
*/
RDKIX_DESCRIPTORS_EXPORT double eccentricity(const ROMol&, int confId = -1,
                                             bool useAtomicMasses = true,
                                             bool force = false);
...
*/
RDKIX_DESCRIPTORS_EXPORT double asphericity(const ROMol&, int confId = -1,
                                            bool useAtomicMasses = true,
                                            bool force = false);
...
*/
RDKIX_DESCRIPTORS_EXPORT double spherocityIndex(const ROMol&, int confId = -1,
                                                bool force = false);
