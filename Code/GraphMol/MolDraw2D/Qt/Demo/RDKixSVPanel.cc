...
// ****************************************************************************
RDKixSVPanel::RDKixSVPanel(bool left_slider, QWidget *parent, Qt::WindowFlags f)
    : QWidget(parent, f) {
  build_widget(left_slider);
}

// ****************************************************************************
void RDKixSVPanel::set_molecules(const vector<RDKix::ROMOL_SPTR> &new_mols,
                                 const vector<vector<int>> &highlight_atoms) {
#ifdef NOTYET
  cout << "RDKixSVPanel::set_molecules : " << new_mols.size() << endl;
#endif
...
// ****************************************************************************
void RDKixSVPanel::set_label(const QString &new_label) {
...
// ****************************************************************************
void RDKixSVPanel::build_widget(bool left_slider) {
  QHBoxLayout *hbox = new QHBoxLayout;
  mol_draw_ = new RDKix::MolDisplay2DWidget;

  mol_slider_ = new QSlider;
  connect(mol_slider_, &QSlider::valueChanged, this,
          &RDKixSVPanel::slot_slider_changed);
...
// ****************************************************************************
void RDKixSVPanel::slot_slider_changed() {
  if (mols_.empty()) {
    mol_draw_->set_display_mol(RDKix::ROMOL_SPTR());
  } else {
