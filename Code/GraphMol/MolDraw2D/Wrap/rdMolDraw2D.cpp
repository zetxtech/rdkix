//
//  Copyright (C) 2015-2023 Greg Landrum and other RDKix Contributors
//
//   @@ All Rights Reserved @@
...
#ifdef RDK_BUILD_CAIRO_SUPPORT
python::object getCairoDrawingText(const RDKix::MolDraw2DCairo &self) {
...
python::object getBgColour(const RDKix::MolDrawOptions &self) {
  return colourToPyTuple(self.backgroundColour);
}
python::object getQyColour(const RDKix::MolDrawOptions &self) {
  return colourToPyTuple(self.queryColour);
}
python::object getHighlightColour(const RDKix::MolDrawOptions &self) {
  return colourToPyTuple(self.highlightColour);
}
void setBgColour(RDKix::MolDrawOptions &self, python::tuple tpl) {
  self.backgroundColour = pyTupleToDrawColour(tpl);
}
void setQyColour(RDKix::MolDrawOptions &self, python::tuple tpl) {
  self.queryColour = pyTupleToDrawColour(tpl);
}
void setHighlightColour(RDKix::MolDrawOptions &self, python::tuple tpl) {
  self.highlightColour = pyTupleToDrawColour(tpl);
}
python::object getSymbolColour(const RDKix::MolDrawOptions &self) {
  return colourToPyTuple(self.symbolColour);
}
void setSymbolColour(RDKix::MolDrawOptions &self, python::tuple tpl) {
  self.symbolColour = pyTupleToDrawColour(tpl);
}
python::object getLegendColour(const RDKix::MolDrawOptions &self) {
  return colourToPyTuple(self.legendColour);
}
void setLegendColour(RDKix::MolDrawOptions &self, python::tuple tpl) {
  self.legendColour = pyTupleToDrawColour(tpl);
}
python::object getAnnotationColour(const RDKix::MolDrawOptions &self) {
  return colourToPyTuple(self.annotationColour);
}
void setAnnotationColour(RDKix::MolDrawOptions &self, python::tuple tpl) {
  self.annotationColour = pyTupleToDrawColour(tpl);
}

python::object getVariableAttachmentColour(const RDKix::MolDrawOptions &self) {
  return colourToPyTuple(self.variableAttachmentColour);
}
void setVariableAttachmentColour(RDKix::MolDrawOptions &self,
                                 python::tuple tpl) {
  self.variableAttachmentColour = pyTupleToDrawColour(tpl);
}
void useDefaultAtomPalette(RDKix::MolDrawOptions &self) {
  assignDefaultPalette(self.atomColourPalette);
}
void useBWAtomPalette(RDKix::MolDrawOptions &self) {
  assignBWPalette(self.atomColourPalette);
}
void useAvalonAtomPalette(RDKix::MolDrawOptions &self) {
  assignAvalonPalette(self.atomColourPalette);
}
void useCDKAtomPalette(RDKix::MolDrawOptions &self) {
  assignCDKPalette(self.atomColourPalette);
}
void updateAtomPalette(RDKix::MolDrawOptions &self, python::object cmap) {
  pyDictToColourMap(cmap, self.atomColourPalette);
}
void setAtomPalette(RDKix::MolDrawOptions &self, python::object cmap) {
  self.atomColourPalette.clear();
  updateAtomPalette(self, cmap);
}

void setMonochromeMode_helper1(RDKix::MolDrawOptions &options, python::tuple fg,
                               python::tuple bg) {
  auto fgc = pyTupleToDrawColour(fg);
  auto bgc = pyTupleToDrawColour(bg);
  RDKix::setMonochromeMode(options, fgc, bgc);
}

void setMonochromeMode_helper2(RDKix::MolDraw2D &d2d, python::tuple fg,
                               python::tuple bg) {
  auto fgc = pyTupleToDrawColour(fg);
  auto bgc = pyTupleToDrawColour(bg);
  RDKix::setMonochromeMode(d2d, fgc, bgc);
}

void contourAndDrawGaussiansHelper(
    RDKix::MolDraw2D &drawer, python::object pylocs, python::object pyheights,
...
void contourAndDrawGridHelper(RDKix::MolDraw2D &drawer, python::object &data,
  ...
  ROMol *mol_p = nullptr;
  if (mol) {
    mol_p = python::extract<RDKix::ROMol *>(mol);
  }
...
void setColoursHelper(RDKix::MolDraw2DUtils::ContourParams &params,
                      python::object pycolors) {
  std::vector<RDKix::DrawColour> cs;
...
void setContourColour(RDKix::MolDraw2DUtils::ContourParams &params,
                      python::tuple tpl) {
  params.contourColour = pyTupleToDrawColour(tpl);
}
void drawPolygonHelper(RDKix::MolDraw2D &self, python::object py_cds,
                       bool rawCoords) {
...
void drawAttachmentLineHelper(RDKix::MolDraw2D &self, const Point2D &cds1,
...
void drawWavyLineHelper(RDKix::MolDraw2D &self, const Point2D &cds1,
...
void drawArrowHelper(RDKix::MolDraw2D &self, const Point2D &cds1,
...
void setDrawOptions(RDKix::MolDraw2D &self, const MolDrawOptions &opts) {
  self.drawOptions() = opts;
}

void setDrawerColour(RDKix::MolDraw2D &self, python::tuple tpl) {
  self.setColour(pyTupleToDrawColour(tpl));
}

void updateMolDrawOptionsHelper(RDKix::MolDrawOptions &obj, std::string json) {
  MolDraw2DUtils::updateMolDrawOptionsFromJSON(obj, json);
}

void updateDrawerParamsHelper(RDKix::MolDraw2D &obj, std::string json) {
...
BOOST_PYTHON_MODULE(rdMolDraw2D) {
  ...
  python::enum_<RDKix::MultiColourHighlightStyle>("MultiColourHighlightStyle")
      .value("CircleAndLine", RDKix::MultiColourHighlightStyle::CIRCLEANDLINE)
      .value("Lasso", RDKix::MultiColourHighlightStyle::LASSO)
      .export_values();

  std::string docString = "Drawing options";
  python::class_<RDKix::MolDrawOptions, boost::noncopyable>("MolDrawOptions",
                                                            docString.c_str())
      .def_readwrite("dummiesAreAttachments",
                     &RDKix::MolDrawOptions::dummiesAreAttachments)
      .def_readwrite("circleAtoms", &RDKix::MolDrawOptions::circleAtoms)
      .def_readwrite("splitBonds", &RDKix::MolDrawOptions::splitBonds)
      .def("getBackgroundColour", &RDKix::getBgColour, python::args("self"),
           "method returning the background colour")
      .def("getQueryColour", &RDKix::getQyColour, python::args("self"),
           "method returning the query colour")
      .def("getHighlightColour", &RDKix::getHighlightColour,
           python::args("self"), "method returning the highlight colour")
      .def("setBackgroundColour", &RDKix::setBgColour,
           python::args("self", "tpl"),
           "method for setting the background colour")
      .def("setQueryColour", &RDKix::setQyColour, python::args("self", "tpl"),
           "method for setting the query colour")
      .def("setHighlightColour", &RDKix::setHighlightColour,
           python::args("self", "tpl"),
           "method for setting the highlight colour")
      .def("getSymbolColour", &RDKix::getSymbolColour, python::args("self"),
           "method returning the symbol colour")
      .def("setSymbolColour", &RDKix::setSymbolColour,
           python::args("self", "tpl"), "method for setting the symbol colour")
      .def("getAnnotationColour", &RDKix::getAnnotationColour,
           python::args("self"), "method returning the annotation colour")
      .def("setAnnotationColour", &RDKix::setAnnotationColour,
           python::args("self", "tpl"),
           "method for setting the annotation colour")
      .def("getLegendColour", &RDKix::getLegendColour, python::args("self"),
           "method returning the legend colour")
      .def("setLegendColour", &RDKix::setLegendColour,
           python::args("self", "tpl"), "method for setting the legend colour")

      .def("useDefaultAtomPalette", &RDKix::useDefaultAtomPalette,
           python::args("self"),
           "use the default colour palette for atoms and bonds")
      .def("useBWAtomPalette", &RDKix::useBWAtomPalette, python::args("self"),
           "use a black and white palette for atoms and bonds")
      .def("useAvalonAtomPalette", &RDKix::useAvalonAtomPalette,
           python::args("self"),
           "use the Avalon renderer palette for atoms and bonds")
      .def("useCDKAtomPalette", &RDKix::useCDKAtomPalette, python::args("self"),
           "use the CDK palette for atoms and bonds")
      .def("updateAtomPalette", &RDKix::updateAtomPalette,
           python::args("self", "cmap"),
           "updates the palette for atoms and bonds from a dictionary mapping "
           "ints to 3-tuples")
      .def(
          "setAtomPalette", &RDKix::setAtomPalette,
          python::args("self", "cmap"),
          "sets the palette for atoms and bonds from a dictionary mapping ints "
          "to 3-tuples")
      .def_readwrite("atomLabels", &RDKix::MolDrawOptions::atomLabels,
                     "maps indices to atom labels")
      .def_readwrite("atomLabelDeuteriumTritium",
                     &RDKix::MolDrawOptions::atomLabelDeuteriumTritium,
                     "labels deuterium as D and tritium as T")
      .def_readwrite("continuousHighlight",
                     &RDKix::MolDrawOptions::continuousHighlight)
      .def_readwrite("fillHighlights", &RDKix::MolDrawOptions::fillHighlights)
      .def_readwrite("highlightRadius", &RDKix::MolDrawOptions::highlightRadius,
                     "Default radius for highlight circles.")
      .def_readwrite("flagCloseContactsDist",
                     &RDKix::MolDrawOptions::flagCloseContactsDist)
      .def_readwrite("atomRegions", &RDKix::MolDrawOptions::atomRegions,
                     "regions to outline")
      .def_readwrite("includeAtomTags", &RDKix::MolDrawOptions::includeAtomTags,
                     "include atom tags in output")
      .def_readwrite("clearBackground", &RDKix::MolDrawOptions::clearBackground,
                     "clear the background before drawing a molecule")
      .def_readwrite("legendFontSize", &RDKix::MolDrawOptions::legendFontSize,
                     "font size in pixels of the legend (if drawn)")
      .def_readwrite(
          "legendFraction", &RDKix::MolDrawOptions::legendFraction,
          "fraction of the draw panel to be used for the legend if present")
      .def_readwrite("maxFontSize", &RDKix::MolDrawOptions::maxFontSize,
                     "maximum font size in pixels. default=40, -1 means no"
                     " maximum.")
      .def_readwrite("minFontSize", &RDKix::MolDrawOptions::minFontSize,
                     "minimum font size in pixels. default=6, -1 means no"
                     " minimum.")
      .def_readwrite(
          "fixedFontSize", &RDKix::MolDrawOptions::fixedFontSize,
          "font size in pixels. default=-1 means not fixed.  If set,"
          " always used irrespective of scale, minFontSize and maxFontSize.")
      .def_readwrite(
          "baseFontSize", &RDKix::MolDrawOptions::baseFontSize,
          "relative size of font.  Defaults to 0.6.  -1 means use default.")
      .def_readwrite(
          "annotationFontScale", &RDKix::MolDrawOptions::annotationFontScale,
          "Scale of font for atom and bond annotation relative to atom"
          "label font.  Default=0.75.")
      .def_readwrite(
          "fontFile", &RDKix::MolDrawOptions::fontFile,
          "Font file for use with FreeType text drawer.  Can also be"
          " BuiltinTelexRegular (the default) or BuiltinRobotoRegular.")
      .def_readwrite(
          "multipleBondOffset", &RDKix::MolDrawOptions::multipleBondOffset,
          "offset for the extra lines in a multiple bond as a fraction of mean"
          " bond length")
      .def_readwrite("padding", &RDKix::MolDrawOptions::padding,
                     "fraction of empty space to leave around molecule")
      .def_readwrite(
          "bondLineWidth", &RDKix::MolDrawOptions::bondLineWidth,
          "if positive, this overrides the default line width for bonds")
      .def_readwrite("scaleBondWidth", &RDKix::MolDrawOptions::scaleBondWidth,
                     "Scales the width of drawn bonds using image scaling.")
      .def_readwrite("scaleHighlightBondWidth",
                     &RDKix::MolDrawOptions::scaleHighlightBondWidth,
                     "Scales the width of drawn highlighted bonds using"
                     " image scaling.")
      .def_readwrite("highlightBondWidthMultiplier",
                     &RDKix::MolDrawOptions::highlightBondWidthMultiplier,
                     "What to multiply default bond width by for highlighting "
                     "bonds. Default-8.")
      .def_readwrite("prepareMolsBeforeDrawing",
                     &RDKix::MolDrawOptions::prepareMolsBeforeDrawing,
                     "call prepareMolForDrawing() on each molecule passed to "
                     "DrawMolecules()")
      .def_readwrite("fixedScale", &RDKix::MolDrawOptions::fixedScale,
      ...
      .def_readwrite("fixedBondLength", &RDKix::MolDrawOptions::fixedBondLength,
      ...
      .def_readwrite("unspecifiedStereoIsUnknown",
                     &RDKix::MolDrawOptions::unspecifiedStereoIsUnknown,
      ...
      .def_readwrite(
          ...
          &RDKix::MolDrawOptions::singleColourWedgeBonds,
      ...
      .def_readwrite("useMolBlockWedging",
                     &RDKix::MolDrawOptions::useMolBlockWedging,
                     "If the molecule came from a MolBlock, prefer the wedging"
                     " information that provides.  If false, use RDKix rules."
                     "  Default false")
      .def_readwrite("scalingFactor", &RDKix::MolDrawOptions::scalingFactor,
                     "scaling factor for pixels->angstrom when auto scaling"
                     "being used.  Default is 20.")
      .def_readwrite("drawMolsSameScale",
                     &RDKix::MolDrawOptions::drawMolsSameScale,
      ...
      .def_readwrite(
          ...
          &RDKix::MolDrawOptions::useComplexQueryAtomSymbols,
  ...
  python::class_<RDKix::MolDraw2D, boost::noncopyable>(
      ...
      .def(
          ...
          "renders a molecule\n")
      .def(
          "DrawMolecule", RDKix::drawMoleculeHelper2,
          (python::arg("self"), python::arg("mol"),
          ...
          "renders a molecule\n")
      .def(
          "GetMolSize", RDKix::getMolSizeHelper,
          (python::arg("self"), python::arg("mol"),
           python::arg("highlightAtoms") = python::object(),
      ...
      .def("DrawMoleculeWithHighlights",
           RDKix::drawMoleculeWithHighlightsHelper,
      ...
      .def("DrawMolecules", RDKix::drawMoleculesHelper2,
      ...
      .def("FlexiMode", &RDKix::MolDraw2D::flexiMode, python::args("self"),
           "returns whether or not FlexiMode is being used")
      .def(
          "SetFlexiMode", &RDKix::MolDraw2D::setFlexiMode,
      ...
      .def("SetLineWidth", &RDKix::MolDraw2D::setLineWidth,
           python::args("self", "width"), "set the line width being used")
      .def("SetColour", &RDKix::setDrawerColour, python::args("self", "tpl"),
           "set the color being used fr drawing and filling")
      .def("LineWidth", &RDKix::MolDraw2D::lineWidth, python::args("self"),
           "returns the line width being used")
      .def("SetFillPolys", &RDKix::MolDraw2D::setFillPolys,
           python::args("self", "val"),
           "sets whether or not polygons are filled")
      .def("FillPolys", &RDKix::MolDraw2D::fillPolys, python::args("self"),
           "returns whether or not polygons are being filled")
      .def("DrawLine",
           (void(RDKix::MolDraw2D::*)(const Point2D &, const Point2D &, bool)) &
               RDKix::MolDraw2D::drawLine,
      ...
      .def("DrawArrow", RDKix::drawArrowHelper,
           (python::arg("self"), python::arg("cds1"), python::arg("cds2"),
      ...
      .def("DrawRect", &RDKix::MolDraw2D::drawRect,
           ...
           "are in the molecule frame")
      .def("DrawArc",
           (void(RDKix::MolDraw2D::*)(const Point2D &, double, double, double,
                                      bool)) &
               RDKix::MolDraw2D::drawArc,
      ...
      .def("DrawAttachmentLine", &RDKix::drawAttachmentLineHelper,
           (python::arg("self"), python::arg("cds1"), python::arg("cds2"),
      ...
      .def("DrawWavyLine", &RDKix::drawWavyLineHelper,
           (python::arg("self"), python::arg("cds1"), python::arg("cds2"),
           ...
           "(normally a squiggle line perpendicular to a bond)")
      .def("DrawString",
           (void(RDKix::MolDraw2D::*)(const std::string &,
                                      const RDGeom::Point2D &, bool)) &
               RDKix::MolDraw2D::drawString,
           (python::arg("self"), python::arg("string"), python::arg("pos"),
            python::arg("rawCoords") = false),
           "add text to the canvas")
      .def("DrawString", RDKix::drawStringHelper,
           (python::arg("self"), python::arg("string"), python::arg("pos"),
  ...
  python::class_<RDKix::MolDraw2DSVG, python::bases<RDKix::MolDraw2D>,
      ...
      .def("FinishDrawing", &RDKix::MolDraw2DSVG::finishDrawing,
           python::args("self"),
           "add the last bits of SVG to finish the drawing")
      .def("AddMoleculeMetadata",
           (void(RDKix::MolDraw2DSVG::*)(const RDKix::ROMol &, int) const) &
               RDKix::MolDraw2DSVG::addMoleculeMetadata,
           ((python::arg("self"), python::arg("mol")),
            python::arg("confId") = -1),
           "add RDKix-specific information to the bottom of the drawing")
      .def("TagAtoms", RDKix::tagAtomHelper,
           ((python::arg("self"), python::arg("mol")),
            python::arg("radius") = 0.2,
            python::arg("events") = python::object()),
           "allow atom selection in the SVG")
      .def("GetDrawingText", &RDKix::MolDraw2DSVG::getDrawingText,
           python::args("self"), "return the SVG");

#ifdef RDK_BUILD_CAIRO_SUPPORT
  docString = "Cairo molecule drawer";
  python::class_<RDKix::MolDraw2DCairo, python::bases<RDKix::MolDraw2D>,
                 boost::noncopyable>(
      ...
      python::init<int, int, int, int, bool>(
          (python::arg("self"), python::arg("width"), python::arg("height"),
           python::arg("panelWidth") = -1, python::arg("panelHeight") = -1,
           python::arg("noFreetype") = false)))
      .def("FinishDrawing", &RDKix::MolDraw2DCairo::finishDrawing,
           python::args("self"), "add the last bits to finish the drawing")
      .def("GetDrawingText", &RDKix::getCairoDrawingText, python::args("self"),
           "return the PNG data as a string")
      .def("WriteDrawingText", &RDKix::MolDraw2DCairo::writeDrawingText,
  ...
  python::def(
      "PrepareMolForDrawing", &RDKix::prepMolForDrawing,
  ...
  python::def(
      "PrepareAndDrawMolecule", &RDKix::prepareAndDrawMoleculeHelper,
  ...
  python::def(
      "DrawMoleculeACS1996", &RDKix::drawMoleculeACS1996Helper,
      (python::arg("drawer"), python::arg("mol"), python::arg("legend") = "",
       python::arg("highlightAtoms") = python::object(),
       python::arg("highlightBonds") = python::object(),
       python::arg("highlightAtomColors") = python::object(),
...
*/)DOC";
  python::def(
      "ContourAndDrawGaussians", &RDKix::contourAndDrawGaussiansHelper,
      (python::arg("drawer"), python::arg("locs"), python::arg("heights"),
       ...
       python::arg("params") = RDKix::MolDraw2DUtils::ContourParams(),
       python::arg("mol") = python::object()),
      docString.c_str());
...
*/)DOC";
  python::def(
      "ContourAndDrawGrid", &RDKix::contourAndDrawGridHelper,
  ...
  python::def("UpdateMolDrawOptionsFromJSON", RDKix::updateMolDrawOptionsHelper,
              (python::arg("opts"), python::arg("json")));
  python::def("UpdateDrawerParamsFromJSON", RDKix::updateDrawerParamsHelper,
              (python::arg("drawer"), python::arg("json")));

  // ------------------------------------------------------------------------
  docString = "Returns svg for a molecule";
  python::def(
      "MolToSVG", &RDKix::molToSVG,
  ...
  python::def("MolToACS1996SVG", &RDKix::molToACS1996SVG,
