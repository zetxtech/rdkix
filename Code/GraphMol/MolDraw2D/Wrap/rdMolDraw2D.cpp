...
BOOST_PYTHON_MODULE(rdMolDraw2D) {
  ...
  python::class_<RDKix::MolDrawOptions, boost::noncopyable>("MolDrawOptions",
      ...
      .def("getBackgroundColour", &RDKix::getBgColour,
           "method returning the background colour")
      .def("getQueryColour", &RDKix::getQyColour,
      ...
      .def("setQueryColour", &RDKix::setQyColour,
      ...
      .def("getSymbolColour", &RDKix::getSymbolColour,
      ...
      .def("getLegendColour", &RDKix::getLegendColour,
      ...
      .def("useBWAtomPalette", &RDKix::useBWAtomPalette,
      ...
      .def("useCDKAtomPalette", &RDKix::useCDKAtomPalette,
  ...
  python::class_<RDKix::MolDraw2D, boost::noncopyable>(
      ...
      .def("FontSize", &RDKix::MolDraw2D::fontSize,
      ...
      .def("DrawReaction", RDKix::drawReactionHelper,
           (python::arg("self"), python::arg("rxn"),
            ...
            python::arg("confIds") = python::object()),
           "renders a reaction\n")
      .def("Width", &RDKix::MolDraw2D::width,
           "get the width of the drawing canvas")
      .def("Height", &RDKix::MolDraw2D::height,
      ...
      .def("Offset", &RDKix::MolDraw2D::offset,
      ...
      .def("FlexiMode", &RDKix::MolDraw2D::flexiMode,
  ...
  python::class_<RDKix::MolDraw2DCairo, python::bases<RDKix::MolDraw2D>,
      ...
      .def("GetDrawingText", &RDKix::getCairoDrawingText,
